...
/// Since Releazio is a static framework, the bundle containing the resources is copied into the final product.
    static let module: Bundle = {
        let bundleName = "Releazio_Releazio"
        ...
        fatalError("unable to find bundle named Releazio_Releazio")
    }()
}
